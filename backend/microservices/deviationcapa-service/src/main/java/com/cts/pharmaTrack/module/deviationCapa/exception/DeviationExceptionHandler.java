package com.cts.pharmaTrack.module.deviationCapa.exception;
...
/**
 * Deviation/CAPA-service scoped exception handler. Overrides the shared
 ...
 */
@RestControllerAdvice("com.cts.pharmaTrack.module.deviationCapa")
@Order(Ordered.HIGHEST_PRECEDENCE)
public class DeviationExceptionHandler {
